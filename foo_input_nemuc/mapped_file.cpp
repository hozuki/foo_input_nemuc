...
const GUID mapped_file::class_guid = { 0xfdd68e4a, 0xdd9c, 0x405e, {0x8b, 0xc0, 0x19, 0xfb, 0xa3, 0x90, 0x04,0xcd} };

const GUID mapped_file_impl_t::class_guid = { 0xbd27973c, 0x5a0b, 0x403f, {0xa6, 0x54, 0x0d, 0xce, 0x29, 0x0d, 0x7b,0xec} };
